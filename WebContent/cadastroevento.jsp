...
<!--         </div> -->
        <div class="btn-group" role="group">
            <button type="button" id="following" class="btn btn-default" href="#tab1" data-toggle="tab"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
...
<!--   TESTE IMAGEM -->
<!-- NORMAL -->
<!--   <form class="form-horizontal" action="/ToAqui/CadastroEstabelecimentoServlet" method="post"> -->
<!-- TESTE -->
<form class="form-horizontal" id="formImagem" name="filename" method="post" action="/ToAqui/CadastroEvento" enctype="multipart/form-data">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="nome" type="text" placeholder="nome da festa" class="form-control input-md" required="required">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="local" type="text" placeholder="nome do local ou clube" class="form-control input-md" required="required">
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <input class="form-control" id="data_evento" name="data_evento" type="text"></input>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <input class="form-control" id="" name="valor_ingresso" required="required"></input>
  </div>
</div>
