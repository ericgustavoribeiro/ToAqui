...
<!-- <div class="alert alert-info" role="alert">Anunicar</div>
 -->  </div>
  ...
  <div class="container-fluid" style="background-image:url('img/slider-bg5.jpg'); margin-left:"   ><!-- div central -->
<h1>oioioioi</h1>
  
   <div class="row"> <!-- DADOS -->
   
  <div class="col-sm-4" style="padding-left: 10%;"> <!-- img -->
      <div id="gallery" >
       <ul><li>	
...
<img src="<%=estab.getImagem() %>" width="450" height="350" alt="" title="Img#1" /></a>
  ...
  <div class="col-sm-8" style="padding-left: 10%;">.col-sm-8</div>
</div> <!-- FIM DADOS -->
