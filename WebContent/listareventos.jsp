  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav"> 
		...
		<li class="active"><a href="listareventos.jsp"><font color=""><strong>Eventos</strong></font></a></li>
...
<div class="container-fluid" style="margin-top: 0%;">
  ...
  <div class="panel panel-default" style="background-image:url('img/evento_banner1.jpg');height:350px;">
...
<hr>
 ...
 <div class="row">
			...
			<%
				...
				ArrayList<Evento> listar = fachada.eventoListar();
...
<strong> <%=evento.getNome().toUpperCase() %> <br> </strong>

<img style="max-width:200px; min-width: 200px;  " src="<%=evento.getImagem() %>" height="350" alt="<%=evento.getNome() %>" title="Img#1" />
...
<button onclick="location.href='resultadoevento.jsp?nome=<%=evento.getNome()%>'" type="button" class="btn btn-info" style="margin-top:-20%; margin-left: 85%;"><i class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="top" title="Mais informa�oes sobre o estabelecimento""> Info</i></button></li></ul>
