...
%>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><%=user.getEmail() %></td>
                                            <td>
                                        	 <input type="button" class="btn btn-info btn-xs" aling="center" onclick="location.href='../../RemoverUsuarioServlet?id_user=<%=user.getId_user()%>'" value="REMOVER">
                                        	</td>
                                        </tr>
...
<% }%>
        ...
        <div class="panel-footer">total usuarios : <%=contadorUser %></div>
      </div>
    </div>
  </div>
