    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
	    <link href="css/bootstrap.css.map" rel="stylesheet">
			    ...
			    <link href="css/corfundo.css" rel="stylesheet">
				 ...
				 <link href="css/csstbat" rel="stylesheet">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav"> 
               <li class="active"><a href="listarbar.jsp" ><strong>Bares</strong></a></li>
...
<!-- <div class="alert alert-info" role="alert">Anunicar</div>
 -->  </div>
  ...
  <div class="col-md-12" style="background-image:url('img/drink.jpg'); margin-left:"   ><!-- div central -->
<div class="container"  style="  margin-bottom:2% " >
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
   ...
   <div class="item">
        <img src="img/foto5.jpg" alt="Chania" width="700" height="420">
        <div class="carousel-caption">
          <h3>Chania</h3>
          <p>The atmosphere in Chania has a touch of Florence and Venice.</p>
        </div>
	...
	<section class="" style="border-radius:1px;  background-image: linear-gradient(#1A8BE2,#004FA6);" >
		...
		<div class="container">
			...
			<div class="col-md-6" class="">
					  ...
					  <img style="padding: 0%;" src="images/facebook48.png" alt="facebook"> 
					<img style="padding: 0%;"src="images/instagram48.png" alt="instagram"> 
					<img style="padding: 0%;"src="images/twitter48.png" alt="twitter"> 
					<img style="padding: 0%;"src="images/snapchat48.png" alt="snapchat"> 
 ...
 <div class="row">
			...
			<%
				...
				for (Estabelecimento estabs : listar) {
					if(estabs.getCategoria().equalsIgnoreCase("Bar")){
      ...
      <div id="gallery">
       <ul><li>	
       <p> <a href="<%=estabs.getImagem() %>" rel="lightbox" title="<%=estabs.getNome().toUpperCase() %>" class="thumbnail">
<strong> <%=estabs.getNome().toUpperCase() %></strong>

<img src="<%=estabs.getImagem() %>" width="350" height="350" alt="" title="<%=estabs.getNome() %>" /></a>

            <button onclick="location.href='resultadobuscaestabelecimento.jsp?nome=<%=estabs.getNome()%>'" type="button" class="btn btn-info" style="margin-top:-20%; margin-left: 85%;"><i class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="top" title="Mais informaçoes sobre o estabelecimento""> Info</i></button></li></ul>
...
$(document).ready(function() {
  $('#media').carousel({
	...
	<div
		...
		data-a2a-title="#ToAqui!  Quem Anuncia vende Mais! ">
		<figure><a href="index.jsp"><i class="glyphicon glyphicon-home"></i></a></figure>
